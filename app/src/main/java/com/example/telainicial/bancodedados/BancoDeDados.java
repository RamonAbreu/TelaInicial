...
public class BancoDeDados {
    ...
    public Cursor obterAnotacoes(){
        ...
        Cursor cursor = db.query("anotacoes", campos, null, null,
                null, null, "titulo ASC");
        if(cursor!=null){
            cursor.moveToFirst();
        }
        db.close();
    ...
    public void excluirAnotacao(int id, String titulo, String conteudo){
        SQLiteDatabase db = gerenciarBanco.getReadableDatabase();
        String where = "_id="+id;
    ...
    public Cursor consultarAnotacaoPeloId(int notaId) {
        ...
        SQLiteDatabase db = gerenciarBanco.getReadableDatabase();
        Cursor cursor =  db.query("anotacoes", campos, where, null, null,
                null, null);
